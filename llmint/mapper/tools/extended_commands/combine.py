...
class SplitSchema(BaseModel):
    new_field_name: str = Field(description="should be a a singular field name that has different values between the source and target schema")
    field_1: str = Field(description="")
    field_2: str = Field(description="")
